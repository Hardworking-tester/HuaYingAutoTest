# encoding:utf-8
from Action import ZhuCe_yezhujiashu
import unittest
...
class ZhuCeyezhujiashu(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s=ZhuCe_yezhujiashu.ZhuCeYeZhuJiaShu(self.driver)

        sleep(5)

    def testZhuceYeZhuJiaShu(self):
        path_excel=Get_ExcelPath_SheetName.Get_ExcelPath_SheetName().getExcelPath("F:\\Community_DD\\Data\\zhuce_jiashu.xls","excelpath_sheetname")
        name_sheet_list=(Get_ExcelPath_SheetName.Get_ExcelPath_SheetName().GetSheetName("F:\\Community_DD\\Data\\zhuce_jiashu.xls","excelpath_sheetname"))
        pp=self.s
