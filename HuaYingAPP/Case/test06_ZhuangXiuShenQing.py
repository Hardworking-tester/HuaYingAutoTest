...
class ZhuangXiuShenQingTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s=ZhuangXiuShenQing.ZhuangXiuShenQing(self.driver)
        sleep(10)

    def testZhuangXiuShenQing(self):
        pp=self.s
        excel_path=Get_ExcelPath_SheetName.Get_ExcelPath_SheetName().getExcelPath("F:\\Community_DD\\Data\\zhuangxiushenqing.xls","excelpath_sheetname")
        sheet_name_list=Get_ExcelPath_SheetName.Get_ExcelPath_SheetName().GetSheetName("F:\\Community_DD\\Data\\zhuangxiushenqing.xls","excelpath_sheetname")
